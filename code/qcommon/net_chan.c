...
This function is strict to the extreme degree;
octets must be in base 10 and non-zero octets may
not have leading 0's.

Use this function to check that it's a raw IP address
before passing it to NET_StringToAdr to ensure that no
DNS lookups will take place.  This is a very efficient
operation and will take very few CPU cycles.
====================
*/
